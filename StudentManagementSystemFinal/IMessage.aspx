<%@ Page Title="" Language="C#" MasterPageFile="~/InstructorMaster.master" AutoEventWireup="true" CodeFile="IMessage.aspx.cs" Inherits="IMessage" %>
<%@ MasterType VirtualPath="~/InstructorMaster.master" %>
<asp:Content ID="Content500" ContentPlaceHolderID="Heading8" Runat="Server">
      <div class="row">
        <div class="col-lg-12">
...
<asp:Content ID="Content499" ContentPlaceHolderID="IMessage" Runat="Server">
      <div class="container">
        <div class="row">
                       ...
                       <asp:AsyncPostBackTrigger ControlID="btnDelete" />
                                 ...
                                 <ContentTemplate>
                                     <asp:PlaceHolder ID="DBDataPlaceHolder" runat="server"></asp:PlaceHolder> 
                                      <asp:Label ID="lblEmpty" runat="server" Text="" ForeColor="Maroon" Font-Size="X-Large"></asp:Label>
