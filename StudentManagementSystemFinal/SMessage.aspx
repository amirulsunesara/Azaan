<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMaster.master" AutoEventWireup="true" CodeFile="SMessage.aspx.cs" Inherits="_Default" %>
<%@ MasterType VirtualPath="~/StudentMaster.master" %>
<asp:Content ID="Content500" ContentPlaceHolderID="Heading4" Runat="Server">
      <div class="row">
        <div class="col-lg-12">
...
<asp:Content ID="Content499" ContentPlaceHolderID="SMessage" Runat="Server">
