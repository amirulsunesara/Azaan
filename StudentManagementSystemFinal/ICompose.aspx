<%@ Page Title="" Language="C#" MasterPageFile="~/InstructorMaster.master" AutoEventWireup="true" CodeFile="ICompose.aspx.cs" Inherits="_Default" %>
<%@ MasterType VirtualPath="~/InstructorMaster.master" %>

<asp:Content ID="Content51" ContentPlaceHolderID="Heading256" Runat="Server">
      <div class="row">
        <div class="col-lg-12">
...
<asp:Content ID="Content121" ContentPlaceHolderID="ICompose" Runat="Server">
    <label id="lblSent" runat="server">Message has been Successfully Sent! Go To <a href="IMessage.aspx">Inbox</a></label>
